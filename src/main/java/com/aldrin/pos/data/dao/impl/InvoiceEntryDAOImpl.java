    ...
    public ArrayList<InvoiceEntry> selectInvoiceEntry(InvoiceEntry ie) {
        ...
        try {
            String query = "SELECT \n"
                    ...
                    + "    STOCK_IN_ENTRY \n"
                    + "ON \n"
                    + "    (INVOICE_ENTRY.STOCKIN_ENTRY_ID = ALDRIN.STOCK_IN_ENTRY.ID) \n"
                    + "INNER JOIN \n"
                    + "    ALDRIN.PRODUCT \n"
                    + "ON \n"
                    + "    (STOCK_IN_ENTRY.PRODUCT_ID = ALDRIN.PRODUCT.ID) \n"
                    + "INNER JOIN \n"
                    + "    UNIT \n"
                    + "ON \n"
                    + "    (STOCK_IN_ENTRY.UNIT_ID = ALDRIN.UNIT.ID)\n"
    ...
    public void comboBoxInvoiceStart() {
        ...
        try {
            ...
            statement = getCon().prepareStatement("SELECT \n"
                    ...
                    + "    INVOICE \n"
                    + "ON \n"
                    + "    (ALDRIN.INVOICE_ENTRY.INVOICE_ID = ALDRIN.INVOICE.ID) GROUP BY INVOICE_ENTRY.INVOICE_ID, \n"
