...
public class UnitDAOImpl extends DBConnection implements UnitDAO {
    ...
    public void addUnit(Unit unit) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("INSERT INTO ALDRIN.UNIT (ID,UNIT,DESCRIPTION) VALUES  (?,?,?) ");
    ...
    public void updateUnit(Unit unit) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("UPDATE ALDRIN.UNIT SET UNIT =?, DESCRIPTION =? WHERE UNIT.ID = ?");
    ...
    public void deleteUnit(Unit unit) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("UPDATE ALDRIN.UNIT SET DELETED =? WHERE UNIT.ID = ? ");
    ...
    public ArrayList<Unit> selectUnit() {
        ...
        try {
            String query = "SELECT * FROM ALDRIN.UNIT WHERE UNIT.DELETED =FALSE  ORDER BY UNIT ASC ";
            getDBConn();
    ...
    public void comboBoxUnit() {
        ...
        try {
            ...
            ResultSet rs;
            statement = getCon().prepareStatement("SELECT * FROM ALDRIN.UNIT  WHERE UNIT.DELETED =FALSE ORDER BY UNIT ASC ");
