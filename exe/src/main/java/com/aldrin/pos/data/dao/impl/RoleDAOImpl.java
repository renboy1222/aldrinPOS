...
public class RoleDAOImpl extends DBConnection implements RoleDAO {
    ...
    public void addRole(Role role) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("INSERT INTO ALDRIN.ROLE (ID,ROLE,DESCRIPTION) VALUES  (?,?,?) ");
    ...
    public void updateRole(Role role) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("UPDATE ALDRIN.ROLE SET ROLE =?, DESCRIPTION =? WHERE ROLE.ID = ?");
    ...
    public void deleteRole(Role role) {
           try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("UPDATE ALDRIN.ROLE SET DELETED =? WHERE ROLE.ID = ? ");
    ...
    public ArrayList<Role> selectRole() {
        ...
        try {
            String query = "SELECT * FROM ALDRIN.ROLE WHERE ROLE.ACTIVE =TRUE  ORDER BY ROLE ASC ";
            getDBConn();
    ...
    this.setList(new ArrayList<ComboBoxList>());
        try {
            ...
            ResultSet rs;
            statement = getCon().prepareStatement("SELECT * FROM ALDRIN.ROLE WHERE ROLE.ACTIVE=TRUE  ORDER BY ROLE ASC ");
